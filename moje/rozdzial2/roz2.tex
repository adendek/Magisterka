...
Niniejszy rozdział stanowi krótkie wprowadzenie do eksperymentu LHCb (ang. Large Hadron Collider beauty expermient). Na samym początku opisany jest słynny akcelerator LHC a następnie rozdział mówi o detektorze LHCb. Opisuje jego podstawowe zadania oraz ich praktyczna sprzętową realizację. 
...
\begin{figure}[!ht]
 ...
 \caption{Schemat magnesu zakrzywiającego wchodzącego w skład systemu detekcyjnego LHCb(a) oraz wielkość składowej y-owej indukcji pola magnetycznego jako funkcja współrzędnej z-owej.  \cite{magnet}}
 \label{fig:magnes}
\end{figure}
...
\begin{figure}[th] 
  ...
  % OT-Module-design.jpg: 385x326 pixel, 100dpi, 9.78x8.28 cm, bb=0 0 277 235
  \caption{Zdjęcie detektora ECAL po zamontowaniu go w detektorze LHCb.\cite{public}}
  \label{fig:ECAl}
\end{figure}
...
\begin{figure}[H] 
  ...
  % OT-Module-design.jpg: 385x326 pixel, 100dpi, 9.78x8.28 cm, bb=0 0 277 235
  \caption{Schematyczne przedstawienie (widok z boku) stacji mionowych oraz żelaznych absorberów umieszczonych pomiędzy stacjami.\cite{public}}
  \label{fig:Muon}
\end{figure}
